...
public class dateCalculations {
	...
	int getDifference(Date_input dt1, Date_input dt2) 
    {  
	...
	Date_input addDate(Date_input dt1, int n)
	{
		int y = n/365;
		Date_input dt2 = dt1;
		dt2.y = dt2.y + y;
	...
	Date_input subDate(Date_input dt1, int n)
	{
		int y = n/365;
		Date_input dt2 = dt1;
		dt2.y = dt2.y - y;
	...
	String dayofweek(Date_input dt1) 
	{ 
		int y = dt1.getY();
		int m = dt1.getM();
		int d = dt1.getD();
